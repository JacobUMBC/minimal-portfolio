...
function App() {
  ...
  return (
    <>
      <button
        type="button"
        onClick={handleThemeSwitch} // Fix: Corrected onClick syntax
        className="fixed p-2 z-10 right-20 top-4 bg-violet-300 dark:bg-orange-300 text-lg p-1 rounded-md"
      >
        {theme === 'dark' ? sun : moon}
      </button>

      <div className="bg-white dark:bg-stone-900 text-stone-900 dark:text-stone-300 min-h-screen four-inter">
